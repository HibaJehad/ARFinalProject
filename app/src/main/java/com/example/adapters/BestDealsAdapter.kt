...
import com.example.homesweethome.databinding.BestDealsRvItemBinding
import com.example.homesweethome.databinding.SpecialRvItemBinding
        ...
        fun bind(product:Product){
            ...
            binding.apply {
                ...
                product.offerPercentage?.let {
                    ...
                    tvPrice.text = "Shekel ${String.format("%.2f",priceAfterOffer)}"
                }
                tvBestDealsOldPrice.text = "Shekel ${product.price}"
