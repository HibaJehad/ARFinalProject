...
import com.example.homesweethome.databinding.AddressRvItemBinding
import com.example.homesweethome.databinding.BillingProductsRvItemBinding
    ...
    inner class BillingViewHolder(val binding: BillingProductsRvItemBinding):ViewHolder(binding.root) {
        fun bind(billingProduct: CartProduct) {
            binding.apply {
                ...
                tvProductCartPrice.text = "Shekel ${billingProduct.product.price}"
                ...
                billingProduct.product.offerPercentage?.let {
                    ...
                    tvProductCartPrice.text = "Shekel ${String.format("%.2f", priceAfterOffer)}"
                }
